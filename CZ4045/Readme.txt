...
All the paths used in the following steps are relative to SourceCode/ directory.  The explanation about the output can be seen in the report.
...
4. Output: items dictionary which consist of list of post items. 
{
    "items": [
        {
            "body": <post_body>,
...
*[, answer-<answer_id>] only exists in answer posts
...
4. Sample Output: (brat/data/stackoverflow/2011-01-01-2011-06-30.conll)
	O	114	115	I
	O	116	121	tried
...
+=========================+
1. Results and confusion matrices can be found in:
...
3. Diff and Compare the Classification Results on Brat
